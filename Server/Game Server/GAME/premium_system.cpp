...
// !@ tempor�rio
constexpr uint32_t PREMIUM_CLUBSET_TYPEID = 268435543; // Rank D(0x1000005D), Rank S(0x1000006B), (Premium)

// !@ tempor�rio
constexpr uint32_t PREMIUM_2_CLUBSET_TYPEID = 268435543; // Rank D(0x1000005D), Rank S(0x1000006B), (Premium)
