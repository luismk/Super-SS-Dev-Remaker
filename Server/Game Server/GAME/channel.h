...
namespace stdA {
    class channel {
		...
		public:	// REQUEST FROM CLIENT
			...
			void requestExecCCGNoticePrize(player& _session, packet* _packet);
			...
			int CommandByChat(player& _session, std::stringstream command);
		protected:
        ...
        private:
			...
			unsigned char m_state_fake_connection;
			int m_fake_connetion;
