...
response* CmdInsertTicketReportData::prepareConsulta(database& _db) {
	...
	if (m_trd.bonus_pang >= 1844674407)
	{
		m_trd.bonus_pang = 0;
	}
	...
	//exec pangya.ProcInsertTicketReportDados 83155, 4875, -22(record), 0(medal), 0trofeu, 3327pang, 18446744073709549744, 55, 1073741887, 1, 0, 0, N'2023-05-29 14:31:53.547
